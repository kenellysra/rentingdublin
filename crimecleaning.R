...
crimefile<-read.csv("crimesfile.csv", header = T, na.strings = c(""))
...
#Changing type of crimes and year from collumn to row
...
write.csv(crimedf, file = "crimecleaned.csv")
